 ...
 */
export async function startDockerContainers(installDir: string): Promise<boolean> {
  ...
  try {
    ...
    spinner.text = 'Building and starting containers (this may take a few minutes)...';
 ...
 */
export async function stopDockerContainers(installDir: string): Promise<boolean> {
