...
export function generateEnvFile(config: EnvConfig): string {
  // Determine data directory path (relative to installation directory)
  const dataDir = "./desterlib-data";
...
# Paths are relative to this directory, or use absolute paths
METADATA_PATH=${dataDir}/metadata
API_LOG_PATH=${dataDir}/logs
...
# - METADATA_PATH and API_LOG_PATH must be set for the API to start
`;
}
