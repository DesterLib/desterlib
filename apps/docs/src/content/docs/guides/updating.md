...
Follow updates:
- ⭐ Star the [GitHub repo](https://github.com/DesterLib/desterlib)
- 👀 Watch releases on GitHub
- 📢 Join [GitHub Discussions](https://github.com/DesterLib/desterlib/discussions)
...
1. ✅ **Backup your database** - See [Backup Guide](/guides/backup-restore/)
2. ✅ **Read release notes** - Check for breaking changes
3. ✅ **Stop running scans** - Avoid interrupting operations
...
3. ✅ **Verify API docs** - Visit `http://localhost:3001/api/docs`
4. ✅ **Test streaming** - Play a video
