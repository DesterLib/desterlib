...
interface HeaderProps {
  ...
  showSearch?: boolean;
  notificationCenter?: preact.ComponentChildren;
}
  ...
  return (
    <>
      <div className="hidden md:block sticky top-0 z-50 mx-auto p-4">
        <div className="max-w-[600px] mx-auto relative">
          <motion.div
            ...
            className="border border-white/10 bg-black/40 backdrop-blur-lg rounded-[50px] font-semibold overflow-visible mx-auto relative"
          >
          ...
          {/* Notification Center - Desktop (Outside Navigation) */}
          {notificationCenter && (
      ...
      <div className="md:hidden fixed bottom-0 left-0 right-0 z-50">
        {/* Notification Center - Mobile (Positioned at top-right) */}
        {notificationCenter && (
