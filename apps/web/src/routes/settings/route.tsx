...
function RouteComponent() {
  ...
  return (
    <div className="pt-4 md:pt-[100px] md:px-6 md:pb-0 pb-20 md:h-[calc(100vh-100px)]">
      <div className="max-w-7xl mx-auto md:flex md:gap-6 md:h-full">
        {/* Desktop Sidebar - Hidden on mobile */}
        <nav className="hidden md:block md:w-64 md:flex-shrink-0 md:h-full md:overflow-y-auto py-4">
          <div className="space-y-4">
            ...
            <div className="bg-white/5 border border-white/10 rounded-xl overflow-hidden">
              ...
              <div className="p-1.5 space-y-0.5">
                ...
                <Link
                  to="/settings/libraries"
                  className="w-full px-3 py-2 rounded-lg text-sm font-medium text-left transition-colors flex items-center gap-2 text-white/70 hover:bg-white/5 hover:text-white"
                >
        ...
        <div className="flex-1 flex flex-col md:w-full md:overflow-hidden">
          ...
          {/* Main Content Area */}
          <div className="flex-1 md:h-full md:overflow-hidden px-4 md:px-0">
            <Outlet />
          </div>
        </div>
      </div>
